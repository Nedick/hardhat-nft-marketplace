...
contract ReentrantVulnerable {
    ...
    // You can prevent re-entrancy in two ways:
    // 1. Easy way is to make any external call a last step in a transaction.
    // Example: update balances[msg.sender] = 0; before the external call (bool sent, ) = msg.sender.call{value: bal}("");
    // 2. Another way is to use mutex locks.
    // Example: bool locked; and require(!locked, "revert");
